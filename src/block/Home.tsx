...
const HomeComponent = () => {
    return (
        <div className="w-full h-full flex flex items-center border-[8px] bg-card border-border justify-center p-[36px] shadow-[12px_12px_0px_0px_theme(colors.muted-foreground)] rounded-xl">
